...
with st.sidebar:
    choose = option_menu("Main Menu", ["About", "Tutorials","Apps", "Contact"],
...
if choose == "About":
    ...
    st.image(profile, width=700 )
        ...
        #st.write('') 
        if topic=='Pandas':
            st.subheader('Featured Pandas Tutorials')
            st.write('---')
            ...
            with st.container():
                ...
                with text_col:
                    ...
                    st.markdown("As a data scientist, you must have encountered this problem at least once in your data science journey: you import your data into a Pandas dataframe... [Continue to Read on Towards Data Science](https://towardsdatascience.com/clean-a-numeric-id-column-in-pandas-dataframe-fbe03c11e330)")
            ...
            feature_image2 = Image.open(r'C:\Users\13525\Desktop\Insights Bees\streamlit_website\Images\feature_image2.png')
            with st.container():
                image_col, text_col = st.columns((1,3))
                with image_col:
                ...
                with text_col:
                    ...
                    st.markdown("As data scientists, we know that data does not always come to us with the most desirable format... [Continue to Read on Towards Data Science](https://towardsdatascience.com/clean-a-numeric-id-column-in-pandas-dataframe-fbe03c11e330)")
            ...
            with col1: 
                ...
                if st.button('Read PDF Tutorial',key='4'): 
                    ...
                    show_pdf('post3-compressed.pdf')
            with col2:
                st.button('Close PDF Tutorial',key='5')                   
            with col3:
                # if st.button('Download PDF Tutorial',key='3'):
                        with open("post3-compressed.pdf", "rb") as pdf_file:
                            PDFbyte = pdf_file.read()
            ...
            feature_image3 = Image.open(r'C:\Users\13525\Desktop\Insights Bees\streamlit_website\Images\feature_image3.png')
            with st.container():
                image_col, text_col = st.columns((1,3))
                with image_col:
                ...
                with text_col:
                    ...
                    st.markdown("If you have been following my Medium blog for some time, you may notice that I usually like to share... [Continue to Read on CodeX](https://towardsdatascience.com/clean-a-numeric-id-column-in-pandas-dataframe-fbe03c11e330)")
